...
the_dark_knight_rises = media.Movie(
                                ...
                                "Batman against the brutal guerilla"
                                " terrorist Bane",
                                "https://upload.wikimedia.org/wikipedia/en/8/"
                                "83/Dark_knight_rises_poster.jpg",
                                "https://www.youtube.com/watch?v=g8evyE9TuYk"
                                )

the_dark_knight = media.Movie(
                        "The Dark Knight",
                        "Batman against the sadistic criminal mastermind"
                        " known as Joker",
                        "https://upload.wikimedia.org/wikipedia/en/8/"
                        "8a/Dark_Knight.jpg",
...
batman_begins = media.Movie(
                        "Batman Begins",
                        "Batman saves Gotham City from Scarecrow and"
                        " the League of Shadows",
                        "https://upload.wikimedia.org/wikipedia/en/a/"
                        "af/Batman_Begins_Poster.jpg",
                        "https://youtu.be/bkU7Cl2SSvI"
                        )

inception = media.Movie(
                    "Inception",
                    "A thief is given the task of planting an idea into the "
                    "mind of a CEO with the use of dream-sharing technology",
...
movies = [dunkirk, interstellar, the_dark_knight_rises,
          inception, the_dark_knight, batman_begins]
